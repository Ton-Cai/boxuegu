...
public class ChangeUserInfoActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        et_contentt = (EditText) findViewById(R.id.et_content);
        iv_delete = (ImageView) findViewById(R.id.iv_delete);
        if (!TextUtils.isEmpty(content)) {
            et_contentt.setText(content);
            et_contentt.setSelection(content.length());
        }
        contentListener();
        ...
        tv_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String etContent = et_contentt.getText().toString().trim();
                switch (flag) {
                    case 1:
    ...
    private void contentListener() {
        et_contentt.addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int before, int count) {
                Editable editable = et_contentt.getText();
                ...
                switch (flag){
                    case 1://昵称
                        ...
                        if (len > 8){
                            ...
                            et_contentt.setText(newStr);
                            editable = et_contentt.getText();
                            //新字符串的长度
