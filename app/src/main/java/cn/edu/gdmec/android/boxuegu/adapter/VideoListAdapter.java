...
public class VideoListAdapter extends BaseAdapter{
    ...
    private OnSelectListner onSelectListener;
    public VideoListAdapter(Context context, OnSelectListner onSelectListener){
    ...
    /**
     * 创建OnSelecyListener接口把位置positio和控件ImageView传递到Activity界面
     */
    public interface OnSelectListner{
        void onSelect(int positon,ImageView iv);
    }
}
