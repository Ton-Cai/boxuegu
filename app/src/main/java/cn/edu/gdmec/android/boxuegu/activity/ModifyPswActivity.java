        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(originalPsw)){
                    ...
                    Toast.makeText(ModifyPswActivity.this, "输入的密码和原始密码不一致", Toast.LENGTH_LONG).show();
                    return;

                }else if (MD5Utils.md5(newPsw).equals(readPsw())){
                    Toast.makeText(ModifyPswActivity.this, "输入的新密码和原始密码不能一致", Toast.LENGTH_LONG).show();
                    return;
                    ...
                    ModifyPswActivity.this.finish();  //关闭但前页面
                }
            }
